       ...
       <div >
            <div className="w-[70vw] ml-auto mr-auto">
              ...
              <div className=" flex self-center  px-8 py-5 bg-primarycontainer">
                <img className="max-w-xs max-h-[60vh] mr-8 " src={publisher.rpgs[0].image_url} ></img>
                <div>
                    ...
                    <br></br>
                    <button className=" mt-1 px-2 py-1 rounded-3xl float-right bg-tertiarycontainer text-surface hover:bg-tertiary hover:text-white border-solid border-2 border-surface hover:border-white">
                        Learn More
                    </button>
                </div>
              </div>
