...
export default function FeaturedGame(props) {
    ...
    return rpg ? (
      ...
      <div className="mx-5 mb-10">
        <div className="p-3 w-[32vw] ml-auto mr-auto flex flex-row justify-around bg-white shadow-md shadow-slate-700
                    border-primary border-4 rounded-md hover:scale-110">
          <img className=" h-[25vh]  shadow-md shadow-slate-900" src={rpg.image_url} ></img>
